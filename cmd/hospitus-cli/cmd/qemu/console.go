...
func runConsole(cmd *cobra.Command, args []string) error {
	...
	// The shared guard, which also resolves a name to its instance: the
	// hand-written provider comparison that stood here skipped that
	// resolution, so a name the rest of the CLI accepts was rejected.
