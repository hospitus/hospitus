...
func newStatsCommand() *cobra.Command {
	return &cobra.Command{
		...
		Short:   "Show resource usage for a container",
...
func runStats(cmd *cobra.Command, args []string) error {
	...
	// Confirmed to be a container instance, as the sibling commands do: without
	// it this reported the metrics of whatever the name resolved to.
	if err := cmdutil.RequireInstanceOf(cmd.Context(), cmdutil.APIClient, name, "container"); err != nil {
		return err
	}
