...
func runExec(cmd *cobra.Command, args []string) error {
	...
	// it, mirroring 'hospitus jail exec'. Returned rather than os.Exit: that
	// skipped every deferred close and left buffered output unwritten.
	if result.ExitCode != 0 {
		return &cmdutil.ExitCodeError{Code: result.ExitCode}
	}
	return nil
}
