...
// providerName is the name the daemon registers this provider under, as the
// container package spells its own. Not the podman binary's name, which is the
// same string for a different reason and stays a literal at its exec sites.
const providerName = "podman"
...
rootless container execution and pod management capabilities.`,
	...
	cmd.AddCommand(cmdutil.NewAutostartCommand(providerName, "container", "containers"))
