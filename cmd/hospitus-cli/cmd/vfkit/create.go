...
func runCreate(cmd *cobra.Command, args []string) error {
	...
	// Not checked here: runtime.GOARCH is the CLI's, and against a remote
	// daemon it describes the wrong machine. The provider refuses a foreign
	// architecture before it writes anything.
