...
// The daemon answers with a real instance, provider included. Returning nil
// made the resolver report no provider at all, which a destroy must refuse:
// the test was asserting that a jail command deletes something it could not
// confirm is a jail.
