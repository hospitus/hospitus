...
func runDestroy(cmd *cobra.Command, args []string) error {
	...
	case pattern != "":
		...
		for _, inst := range instances {
			// The name as well as the id: an operator types the name they see
			// in "hospitus jail list", and a pattern matching only ids
			// silently destroyed nothing where the two differ.
