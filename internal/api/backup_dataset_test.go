...
func TestInstanceDatasetResolverReadsWhatTheProviderRecorded(t *testing.T) {
	// ensureHospitusDataset validates against dataset.Parent(), which honors
	// HOSPITUS_ZFS_PARENT; the literals below only hold under the default.
	t.Setenv("HOSPITUS_ZFS_PARENT", "zroot/hospitus")
