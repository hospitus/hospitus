...
func TestSanitizeString(t *testing.T) {
	tests := []struct {
		...
		{"delete char", "hello\x7fworld", "helloworld"},
...
func BenchmarkValidateInstanceName(b *testing.B) {
	for i := 0; i < b.N; i++ {
		ValidateInstanceName("my-test-jail-123")
	}
}

func BenchmarkValidateIPAddress_IPv4(b *testing.B) {
	for i := 0; i < b.N; i++ {
		ValidateIPAddress("192.168.1.100")
	}
}

func BenchmarkValidateIPAddress_IPv6(b *testing.B) {
	for i := 0; i < b.N; i++ {
		ValidateIPAddress("2001:db8::1")
	}
}

func BenchmarkSanitizeString(b *testing.B) {
	input := "Hello\x00\x01\x02 World with \x1b[31m colors and 世界 unicode"
	for i := 0; i < b.N; i++ {
...
func TestValidateInstanceSpec(t *testing.T) {
	...
	t.Run("description too long", func(t *testing.T) {
		err := ValidateInstanceSpec(provider.InstanceSpec{Name: "vm", Description: string(make([]byte, 1001))})
		if err == nil {
...
func TestValidateInstanceSpec_ExtraFields(t *testing.T) {
	...
	t.Run("annotation key too long", func(t *testing.T) {
		if err := ValidateInstanceSpec(provider.InstanceSpec{
			Name:        "vm",
			Annotations: map[string]string{string(make([]byte, 254)): "val"},
		}); err == nil {
			t.Error("expected error")
		}
	})
	t.Run("annotation value too long", func(t *testing.T) {
		if err := ValidateInstanceSpec(provider.InstanceSpec{
			Name:        "vm",
			Annotations: map[string]string{"key": string(make([]byte, 1001))},
		}); err == nil {
			t.Error("expected error")
		}
	})
...
func TestValidateInstanceName_AllPaths(t *testing.T) {
	t.Run("too long", func(t *testing.T) {
		if err := ValidateInstanceName(string(make([]byte, 64))); err == nil {
...
func TestValidateLabel_AllPaths(t *testing.T) {
	...
	t.Run("key too long", func(t *testing.T) {
		if err := ValidateLabel(string(make([]byte, 254)), "v"); err == nil {
			t.Error("expected error for too-long key")
		}
	})
	t.Run("value too long", func(t *testing.T) {
		if err := ValidateLabel("key", string(make([]byte, 1001))); err == nil {
...
func TestValidateUsername_AllPaths(t *testing.T) {
	...
	t.Run("too long", func(t *testing.T) {
		if err := ValidateUsername(string(make([]byte, 65))); err == nil {
...
func TestValidateInterfaceName_AllPaths(t *testing.T) {
	...
	t.Run("too long", func(t *testing.T) {
		if err := ValidateInterfaceName(string(make([]byte, 16))); err == nil {
