...
func TestRealSystemSysctl(t *testing.T) {
	...
	if _, err := s.Sysctl("hospitus.doctor.no.such.oid"); err == nil {
...
func TestRealSystemFreeBSDProbes(t *testing.T) {
	...
	_ = s.KernelModuleLoaded("nonexistent_module_xyz")
	_ = s.ServiceEnabled("nonexistent_rcvar_xyz")
	_ = s.ZFSPoolExists("nonexistent_pool_xyz")
}
